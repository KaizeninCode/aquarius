...
const NameEntry = () => {
  ...
  const handleContinue = async () => {
    ...
    setName(input.trim())
    // console.log('Navigating to address-picker...');
    router.push("/(account-setup)/address-picker");
  };
  return (
    <KeyboardAvoidingView
    ...
    >
      ...
      <Text className="text-md text-[#666] mb-6">
        So our drivers know who they're delivering to.
      </Text>
      <TextInput
        className="border border-[#ddd] rounded-lg p-3.5 text-[16px] mb-3"
